...
# ---------------------------------------------------------------------------
SSMPHP_CONFIG_VARS='${SIMPLESAMLPHP_BASE_URL_PATH} ${SIMPLESAMLPHP_SECRET_SALT} ${SIMPLESAMLPHP_ADMIN_PASSWORD} ${SIMPLESAMLPHP_TECHNICAL_CONTACT_NAME} ${SIMPLESAMLPHP_TECHNICAL_CONTACT_EMAIL} ${SIMPLESAMLPHP_TIMEZONE} ${SIMPLESAMLPHP_LOGGING_HANDLER}'
